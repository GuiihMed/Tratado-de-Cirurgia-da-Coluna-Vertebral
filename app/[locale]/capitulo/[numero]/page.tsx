...
export async function generateMetadata({
  ...
  const pageUrl = `https://www.tratadodecoluna.com.br/${locale}/capitulo/${num}`;
  ...
  return {
    ...
    alternates: {
      canonical: pageUrl,
      languages: {
        pt: `https://www.tratadodecoluna.com.br/pt/capitulo/${num}`,
        en: `https://www.tratadodecoluna.com.br/en/capitulo/${num}`,
        es: `https://www.tratadodecoluna.com.br/es/capitulo/${num}`,
      },
    },
    openGraph: {
      type: "article",
    ...
    "@graph": [
      {
        ...
        "@id": `https://www.tratadodecoluna.com.br/${locale}/capitulo/${num}#article`,
        "url": `https://www.tratadodecoluna.com.br/${locale}/capitulo/${num}`,
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          },
          {
            "@type": "ListItem",
            "position": 2,
            "name": locale === "en" ? "Index" : locale === "es" ? "Índice" : "A Obra",
            "item": `https://www.tratadodecoluna.com.br/${locale}/indice`
          },
          {
            "@type": "ListItem",
            "position": 3,
            "name": `Capítulo ${num}`,
            "item": `https://www.tratadodecoluna.com.br/${locale}/capitulo/${num}`
          }
        ]
      }
    ]
                  ...
                  <div>
                    ...
                    <div style={{ marginBottom: 14 }}>
                      <CustomVimeoPlayer
                        ...
                        premiereDate={debateEp.dataEstreia}
                        spotifyUrl={debateEp.spotifyUrl}
