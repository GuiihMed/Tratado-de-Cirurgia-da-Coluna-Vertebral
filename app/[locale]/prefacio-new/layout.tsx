...
export async function generateMetadata({
  ...
  const pageUrl = `https://livro-sbc.vercel.app/${locale}/prefacio-new`;
  ...
  return {
    ...
    alternates: {
      canonical: pageUrl,
      languages: {
        pt: "https://livro-sbc.vercel.app/pt/prefacio-new",
        en: "https://livro-sbc.vercel.app/en/prefacio-new",
        es: "https://livro-sbc.vercel.app/es/prefacio-new",
      },
    },
    openGraph: {
      type: "article",
