...
export async function generateMetadata({
  ...
  const pageUrl = `https://www.tratadodecoluna.com.br/${locale}/indice`;
  ...
  return {
    ...
    alternates: {
      canonical: pageUrl,
      languages: {
        pt: "https://www.tratadodecoluna.com.br/pt/indice",
        en: "https://www.tratadodecoluna.com.br/en/indice",
        es: "https://www.tratadodecoluna.com.br/es/indice",
      },
    },
    openGraph: {
      type: "website",
