...
export async function generateMetadata({
  ...
  const pageUrl = `https://livro-sbc.vercel.app/${locale}/indice-new`;
  ...
  return {
    ...
    alternates: {
      canonical: pageUrl,
      languages: {
        pt: "https://livro-sbc.vercel.app/pt/indice-new",
        en: "https://livro-sbc.vercel.app/en/indice-new",
        es: "https://livro-sbc.vercel.app/es/indice-new",
      },
    },
    openGraph: {
      type: "website",
