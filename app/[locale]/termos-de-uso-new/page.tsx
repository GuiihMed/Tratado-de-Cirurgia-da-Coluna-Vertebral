...
export async function generateMetadata({
  ...
  const pageUrl = `https://livro-sbc.vercel.app/${locale}/termos-de-uso-new`;
  ...
  return {
    ...
    alternates: {
      canonical: pageUrl,
      languages: {
        pt: "https://livro-sbc.vercel.app/pt/termos-de-uso-new",
        en: "https://livro-sbc.vercel.app/en/termos-de-uso-new",
        es: "https://livro-sbc.vercel.app/es/termos-de-uso-new",
      },
    },
    openGraph: {
      type: "website",
