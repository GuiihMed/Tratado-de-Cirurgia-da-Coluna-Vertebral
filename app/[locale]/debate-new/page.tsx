...
export default async function DebateNewPage({ params }: DebateNewPageProps) {
  ...
  const videoJsonLd = {
    ...
    "@graph": [
      {
        "@type": "VideoObject",
        "@id": `https://www.tratadodecoluna.com.br/${locale}/debate-new#video-ep4`,
      ...
      {
        "@type": "VideoObject",
        "@id": `https://www.tratadodecoluna.com.br/${locale}/debate-new#video-ep3`,
      ...
      {
        "@type": "VideoObject",
        "@id": `https://www.tratadodecoluna.com.br/${locale}/debate-new#video-ep1`,
      ...
      {
        "@type": "PodcastEpisode",
        "@id": `https://www.tratadodecoluna.com.br/${locale}/debate-new#podcast-ep4`,
        "name": "Episódio 04: Avaliação da Coluna do Paciente Politraumatizado — Tratado em Debate",
      ...
      {
        "@type": "PodcastEpisode",
        "@id": `https://www.tratadodecoluna.com.br/${locale}/debate-new#podcast-ep3`,
        "name": "Episódio 03: Monitorização Neurofisiológica Intraoperatória em Cirurgia de Coluna — Tratado em Debate",
