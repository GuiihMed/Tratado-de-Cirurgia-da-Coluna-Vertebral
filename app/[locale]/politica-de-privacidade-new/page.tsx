...
export async function generateMetadata({
  ...
  const pageUrl = `https://www.tratadodecoluna.com.br/${locale}/politica-de-privacidade-new`;
  ...
  return {
    ...
    alternates: {
      canonical: pageUrl,
      languages: {
        pt: "https://www.tratadodecoluna.com.br/pt/politica-de-privacidade-new",
        en: "https://www.tratadodecoluna.com.br/en/politica-de-privacidade-new",
        es: "https://www.tratadodecoluna.com.br/es/politica-de-privacidade-new",
      },
    },
    openGraph: {
      type: "website",
