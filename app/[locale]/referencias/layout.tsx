...
export async function generateMetadata({
  ...
  const pageUrl = `https://www.tratadodecoluna.com.br/${locale}/referencias`;
  ...
  return {
    ...
    alternates: {
      canonical: pageUrl,
      languages: {
        pt: "https://www.tratadodecoluna.com.br/pt/referencias",
        en: "https://www.tratadodecoluna.com.br/en/referencias",
        es: "https://www.tratadodecoluna.com.br/es/referencias",
      },
    },
    openGraph: {
      type: "website",
