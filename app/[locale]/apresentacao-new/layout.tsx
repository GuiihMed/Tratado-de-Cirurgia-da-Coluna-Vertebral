...
export async function generateMetadata({
  ...
  const pageUrl = `https://www.tratadodecoluna.com.br/${locale}/apresentacao-new`;
  ...
  return {
    ...
    alternates: {
      canonical: pageUrl,
      languages: {
        pt: "https://www.tratadodecoluna.com.br/pt/apresentacao-new",
        en: "https://www.tratadodecoluna.com.br/en/apresentacao-new",
        es: "https://www.tratadodecoluna.com.br/es/apresentacao-new",
      },
    },
    openGraph: {
      type: "article",
