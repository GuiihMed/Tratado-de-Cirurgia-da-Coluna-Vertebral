...
export async function generateMetadata({
  ...
  const pageUrl = `https://livro-sbc.vercel.app/${locale}/home-new`;
  ...
  return {
    ...
    alternates: {
      canonical: pageUrl,
      languages: {
        pt: "https://livro-sbc.vercel.app/pt/home-new",
        en: "https://livro-sbc.vercel.app/en/home-new",
        es: "https://livro-sbc.vercel.app/es/home-new",
      },
    },
    openGraph: {
      type: "website",
