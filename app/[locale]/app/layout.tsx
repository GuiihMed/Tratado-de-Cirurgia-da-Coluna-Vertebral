...
export async function generateMetadata({
  ...
  const pageUrl = `https://www.tratadodecoluna.com.br/${locale}/app`;
  ...
  return {
    ...
    alternates: {
      canonical: pageUrl,
      languages: {
        pt: "https://www.tratadodecoluna.com.br/pt/app",
        en: "https://www.tratadodecoluna.com.br/en/app",
        es: "https://www.tratadodecoluna.com.br/es/app",
      },
    },
    openGraph: {
      type: "website",
