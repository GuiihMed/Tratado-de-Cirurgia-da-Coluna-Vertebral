...
export async function generateMetadata({
  ...
  const pageUrl = `https://www.tratadodecoluna.com.br/${locale}/apresentacao`;
  ...
  return {
    ...
    alternates: {
      canonical: pageUrl,
      languages: {
        pt: "https://www.tratadodecoluna.com.br/pt/apresentacao",
        en: "https://www.tratadodecoluna.com.br/en/apresentacao",
        es: "https://www.tratadodecoluna.com.br/es/apresentacao",
      },
    },
    openGraph: {
      type: "article",
